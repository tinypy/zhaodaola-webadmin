...
<template>
  <DropdownCustom class="app-header-message-vue app-message-dropdown" placement="bottom-end" :toggleIcon="false" ref="messageDropdown">
    ...
    <div slot="content">
      <div class="h-panel">
        ...
        <div v-if="messageList.length>0" class="text-center h-panel-bar">
